...
export class CollapsingHeaderUtilities {
	...
	public validateView(parent: GridLayout, headerView: AbsoluteLayout, contentView: Content): void {
	...
	public displayDevWarning(parent: GridLayout, message: string, ...viewsToCollapse: View[]): void {
